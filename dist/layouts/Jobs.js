                            ...
                            `<div class="relative grid w-full grid-flow-row grid-cols-1 gap-16 max-sm:gap-6 max-md:gap-8 max-lg:gap-10 min-[1024px]:max-[1439px]:gap-10 ${index === config.jobs.length - 1 ? '!pb-0' : ''} pb-16 min-[1024px]:max-[1439px]:pb-12 max-sm:pb-10 max-md:pb-12 lg:grid-cols-2">
                                <div class="relative mb-auto mt-2 grid grid-flow-row gap-16 max-sm:gap-6 max-md:gap-8 max-lg:gap-10 min-[1024px]:max-[1439px]:gap-8 grid-cols-2">
                                    ...
                                    >
                                        ...
                                        <h1 id="job-${index}-from-0" class="bg-gradient-to-r ${colorsConfig[config.color].textPrimary} bg-clip-text pb-4 max-sm:pb-2 text-8xl max-sm:text-[3.25rem] min-[1024px]:max-[1439px]:text-[3.5rem] max-md:text-[4rem] font-bold text-transparent">
                                            ${job.from[0]}
                                        </h1>
                                        <h2 id="job-${index}-from-1" class="pb-2 max-sm:pb-0 max-md:pb-1 min-[1024px]:max-[1439px]:pb-0 text-center text-4xl min-[1024px]:max-[1439px]:text-2xl max-md:text-[2rem] max-sm:text-2xl font-bold">${job.from[1]}</h2>
                                        <h2 class="text-center text-4xl min-[1024px]:max-[1439px]:text-2xl max-md:text-[2rem] max-sm:text-2xl font-bold">
                                            <span id="job-${index}-from-2" class="inline bg-gradient-to-r ${colorsConfig[config.color].textPrimary} bg-clip-text text-transparent">
                                                ${job.from[2]}
                                            </span>
                                        </h2>
                                    ...
                                    >
                                        ...
                                        <h1 id="job-${index}-to-0" class="bg-gradient-to-r ${colorsConfig[config.color].textPrimary} bg-clip-text pb-4 max-sm:pb-2 text-8xl max-sm:text-[3.25rem] min-[1024px]:max-[1439px]:text-[3.5rem] max-md:text-[4rem] font-bold text-transparent">
                                            ${job.to[0]}
                                        </h1>
                                        <h2 id="job-${index}-to-1" class="pb-2 max-sm:pb-0 max-md:pb-1 min-[1024px]:max-[1439px]:pb-0 text-center text-4xl min-[1024px]:max-[1439px]:text-2xl max-md:text-[2rem] max-sm:text-2xl font-bold">${job.to[1]}</h2>
                                        <h2 class="text-center text-4xl min-[1024px]:max-[1439px]:text-2xl max-md:text-[2rem] max-sm:text-2xl font-bold">
                                            <span id="job-${index}-to-2" class="inline bg-gradient-to-r ${colorsConfig[config.color].textPrimary} bg-clip-text text-transparent">
                                                ${job.to[2]}
                                            </span>
                                        </h2>
                                ...
                                <div class="relative flex flex-col items-start">
                                    ...
                                    ${job.button != null ? (
                                        `<div class="flex h-auto w-full flex-col items-start justify-start p-0 pb-6 pt-8 max-sm:pt-6 max-md:pt-6 min-[1024px]:max-[1439px]:pt-6">
                                            <a
                                                ${config.shadow != null ? 'data-shadow' : ''}
                                    ...
                                    ) : `<div class="flex h-auto w-full flex-col items-start justify-start p-0 pb-0 ${index === config.jobs.length - 1 ? 'pt-4' : 'pt-8 max-sm:pt-6 max-md:pt-6 min-[1024px]:max-[1439px]:pt-6'}"></div>`}
                                </div>
                            </div>`
                        )).join('')}
                    </div>
