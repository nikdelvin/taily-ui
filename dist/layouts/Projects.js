                                    ...
                                    ${config.projects.map((project, index) => (
                                        `<div class="relative aspect-video h-[calc(100%+2px)]">
                                            ...
                                            <div class="absolute right-0 top-0 flex h-full flex-col items-center justify-center">
                                                <div class="relative m-8 ml-auto mr-0 flex h-full w-full flex-col items-center justify-start overflow-hidden rounded-l-3xl ${!(index % 2 > 0) ? colorsConfig[config.color].cardBGPrimary : colorsConfig[config.color].cardBGSecondary} text-center backdrop-blur-xl">
                                                    <input
